...
public class TopLevelYoutubeComment {
    ...
    public String toString() {
        ...
        sb.append(TopLevelYoutubeComment.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
